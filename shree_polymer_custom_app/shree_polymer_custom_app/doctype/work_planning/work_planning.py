	...
	def on_cancel(self):
		if self.items:
			try:
				...
				frappe.log_error(message=frappe.get_traceback(),title="shree_polymer_custom_app.shree_polymer_custom_app.doctype.work_planning.work_planning.on_cancel")
...
def get_work_mould_filters():
	try:
		...
		frappe.log_error(message=frappe.get_traceback(),title="shree_polymer_custom_app.shree_polymer_custom_app.doctype.work_planning.work_planning.get_work_mould_filters")
